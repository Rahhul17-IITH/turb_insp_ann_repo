...
# Define the DnCNN-based model
class DnCNN(nn.Module):
    def __init__(self):
        super(DnCNN, self).__init__()
        # Define the DnCNN architecture
...
# Create the DnCNN-based model, loss function, and optimizer
model = DnCNN()
...
restored_image.save('restored_image_dncnn.png')
